...
public class Config {
     ...
     */
    public long randomSpinMin;
    public long randomSpinMax;
     ...
     */
    public int playerCellWidth;

    /**
     * The Height (in pixeks) of player name cell
     */
    public int playerCellHeight;
     ...
     */
     static String[] playerKeysDefaults = {
